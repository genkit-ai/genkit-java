 ...
 * 
 * <p>
 * Supports both direct model IDs and inference profile IDs/ARNs. Inference
 * profiles enable cross-region inference and are required for certain models
 * (e.g., Claude 4.x, Claude 3.5+ models).
 * 
 * <h2>Using Inference Profiles</h2>
 * <p>
 * For models that require inference profiles, you can use either:
 * <ul>
 * <li>Inference profile ID: {@code us.anthropic.claude-sonnet-4-5-v2:0}</li>
 * <li>Model ID (if ON_DEMAND supported): {@code amazon.nova-lite-v1:0}</li>
 * </ul>
 * 
 * @see <a href=
...
public class AwsBedrockPlugin implements Plugin {
  ...
  public static final List<String> SUPPORTED_MODELS = Arrays.asList(
      ...
      "amazon.nova-pro-v1:0", "amazon.nova-lite-v1:0", "amazon.nova-micro-v1:0", "amazon.nova-premier-v1:0",
      "amazon.nova-2-lite-v1:0", "amazon.nova-sonic-v1:0", "amazon.nova-2-sonic-v1:0",
      // Amazon Titan models
      ...
      "anthropic.claude-3-5-sonnet-20240620-v1:0", "anthropic.claude-3-5-haiku-20241022-v1:0",
      ...
      // Meta Llama models
      "meta.llama4-scout-17b-instruct-v1:0", "meta.llama4-maverick-17b-instruct-v1:0",
      "meta.llama3-3-70b-instruct-v1:0", "meta.llama3-2-90b-instruct-v1:0", "meta.llama3-2-11b-instruct-v1:0",
      "meta.llama3-2-3b-instruct-v1:0", "meta.llama3-2-1b-instruct-v1:0", "meta.llama3-1-70b-instruct-v1:0",
      "meta.llama3-1-8b-instruct-v1:0", "meta.llama3-70b-instruct-v1:0", "meta.llama3-8b-instruct-v1:0",
      // Cohere models
      "cohere.command-r-plus-v1:0", "cohere.command-r-v1:0",
      // Mistral models
      "mistral.pixtral-large-2502-v1:0", "mistral.mistral-large-3-675b-instruct", "mistral.magistral-small-2509",
      "mistral.mistral-large-2402-v1:0", "mistral.mistral-small-2402-v1:0", "mistral.ministral-3-14b-instruct",
      "mistral.ministral-3-8b-instruct", "mistral.ministral-3-3b-instruct", "mistral.mixtral-8x7b-instruct-v0:1",
      "mistral.mistral-7b-instruct-v0:2", "mistral.voxtral-mini-3b-2507", "mistral.voxtral-small-24b-2507",
      // DeepSeek models
      "deepseek.r1-v1:0",
      // Google Gemma models
      "google.gemma-3-27b-it", "google.gemma-3-12b-it", "google.gemma-3-4b-it",
      // Qwen models
      "qwen.qwen3-next-80b-a3b", "qwen.qwen3-vl-235b-a22b", "qwen.qwen3-32b-v1:0",
      "qwen.qwen3-coder-30b-a3b-v1:0",
      // NVIDIA models
      "nvidia.nemotron-nano-12b-v2", "nvidia.nemotron-nano-9b-v2", "nvidia.nemotron-nano-3-30b",
      // OpenAI models
      "openai.gpt-oss-120b-1:0", "openai.gpt-oss-20b-1:0", "openai.gpt-oss-safeguard-120b",
      "openai.gpt-oss-safeguard-20b",
      // Writer models
      "writer.palmyra-x5-v1:0", "writer.palmyra-x4-v1:0",
      // MiniMax models
      "minimax.minimax-m2",
      // Moonshot models
  ...
  /**
   * Creates an AwsBedrockPlugin using default AWS credentials and us-east-1
   * region.
   *
   * @return a new AwsBedrockPlugin
   */
  ...
  public List<Action<?, ?, ?>> init() {
    ...
    logger.info("AWS Bedrock plugin initialized with {} models in region {} (supports inference profiles)",
        SUPPORTED_MODELS.size() + customModels.size(), options.getRegion());

    return actions;
  }

  /**
   * Registers a custom model ID or inference profile. Use this to work with
   * models not in the default list or to use inference profiles. Call this method
   * before passing the plugin to Genkit.builder().
   * 
   * @param modelId
   *            the model ID or inference profile ID (e.g.,
