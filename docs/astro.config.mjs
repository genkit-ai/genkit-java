      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Define Agents", slug: "agents/define-agents" },
            { label: "Run and Stream", slug: "agents/run-and-stream" },
            { label: "Serve over HTTP", slug: "agents/serve-over-http" },
            { label: "Sessions", slug: "agents/sessions" },
            { label: "Session Stores", slug: "agents/session-stores" },
            { label: "Interrupts", slug: "agents/interrupts" },
            { label: "Background Execution", slug: "agents/background-execution" },
            { label: "Multi-agent Delegation", slug: "agents/multi-agent-delegation" },
            { label: "Custom Orchestration", slug: "agents/custom-orchestration" },
            { label: "Error Handling", slug: "agents/error-handling" },
          ],
        },
        {
          label: "Observability",
