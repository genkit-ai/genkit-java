 ...
 *
 * <p>This example shows how to: - Configure Genkit with the DeepSeek plugin - Use DeepSeek-Chat for
 * general tasks - Use DeepSeek-Reasoner for complex reasoning - Define flows with tool usage -
 * Generate and stream responses
 *
 * <p>To run: 1. Set the DEEPSEEK_API_KEY environment variable 2. Run: mvn exec:java
 */
public class DeepSeekSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Flow<String, String, Void> greetingFlow =
        genkit.defineFlow(
            "greeting", String.class, String.class, (name) -> "Hello from DeepSeek, " + name + "!");
    ...
    Tool<Map<String, Object>, Map<String, Object>> calculatorTool =
        genkit.defineTool(
            "calculator",
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    "a",
                    Map.of("type", "number", "description", "First number"),
                    "b",
    ...
    Flow<String, String, Void> mathAssistantFlow =
        genkit.defineFlow(
            "mathAssistant",
            String.class,
            String.class,
    ...
    Flow<String, String, Void> reasoningFlow =
        genkit.defineFlow(
            "reasoning",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system(
                              "You are DeepSeek-Reasoner. Break down complex problems step by step and provide clear reasoning.")
                          .prompt(problem)
                          .config(
              ...
              ModelResponse response =
                  genkit.generateStream(
                      GenerateOptions.builder()
                          .model("deepseek/deepseek-chat")
                          .system(
                              "You are a knowledgeable assistant providing detailed explanations.")
                          .prompt(userMessage)
    ...
    Flow<String, String, Void> codeReviewFlow =
        genkit.defineFlow(
            "codeReview",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          .model("deepseek/deepseek-chat")
                          .system(
                              "You are a senior code reviewer. Provide constructive feedback on code quality, "
    ...
    Flow<String, String, Void> problemSolvingFlow =
        genkit.defineFlow(
            "problemSolving",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generateStream(
                      GenerateOptions.builder()
                          .model("deepseek/deepseek-reasoner")
                          .system(
                              "You are an expert problem solver. Think through problems systematically "
    ...
    System.out.println(
        "  POST http://localhost:8080/api/flows/problemSolving (reasoning with streaming)");
    System.out.println("");
