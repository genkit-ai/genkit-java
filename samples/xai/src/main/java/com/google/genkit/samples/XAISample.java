 ...
 *
 * <p>This example shows how to: - Configure Genkit with the XAI plugin - Define flows with Grok
 * models - Use tools with Grok - Generate text with streaming - Expose flows via HTTP endpoints
 *
 * <p>To run: 1. Set the XAI_API_KEY environment variable 2. Run: mvn exec:java
 */
public class XAISample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Flow<String, String, Void> greetingFlow =
        genkit.defineFlow(
            "greeting", String.class, String.class, (name) -> "Hello from Grok, " + name + "!");
    ...
    System.out.println(
        "  POST http://localhost:8080/api/flows/creativeWriting (creative with vision model)");
    System.out.println("");
