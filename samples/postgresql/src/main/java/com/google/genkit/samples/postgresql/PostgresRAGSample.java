 ...
 *
 * <ul>
 *   <li>Configure PostgreSQL plugin with pgvector
 ...
 *   <li>Running PostgreSQL instance with pgvector extension
 *   <li>Optional: POSTGRES_HOST, POSTGRES_PORT, POSTGRES_DB, POSTGRES_USER, POSTGRES_PASSWORD
 * </ul>
 */
  ...
  public static void main(String[] args) {
    ...
    PostgresPlugin postgresPlugin =
        PostgresPlugin.builder()
            ...
            .username(pgUser)
            .password(pgPassword)
            .hikariProperty("maximumPoolSize", 10)
            .hikariProperty("minimumIdle", 2)
            .addTable(
                PostgresTableConfig.builder()
                    .tableName("films")
                    .embedderName("googleai/text-embedding-004")
                    .vectorDimension(768)
                    .distanceStrategy(PostgresTableConfig.DistanceStrategy.L2)
