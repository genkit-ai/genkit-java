 ...
 *
 * <ul>
 *   <li>Configure Firebase plugin with Firestore retriever
 ...
 *   <li>Set GCLOUD_PROJECT environment variable
 *   <li>Configure Google Cloud credentials
 *   <li>Create a Firestore vector index on the 'embedding' field
 * </ul>
 */
public class FirestoreRAGSample {
  ...
  public static void main(String[] args) {
    ...
    Flow<Void, String, Void> indexFilmsFlow =
        genkit.defineFlow(
            "indexFilms",
            Void.class,
            String.class,
    ...
    Flow<String, List<String>, Void> retrieveFilmsFlow =
        genkit.defineFlow(
            "retrieveFilms",
            String.class,
