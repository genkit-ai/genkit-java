...
/**
 * Sample application demonstrating complex input/output types with Genkit flows.
 *
 * <p>This sample shows how to: - Use deeply nested object types - Handle arrays and collections -
 * Work with optional fields - Process maps and generic types - Handle complex domain objects
 */
public class ComplexIOSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Flow<OrderRequest, OrderResponse, Void> processOrder =
        genkit.defineFlow(
            "processOrder",
            OrderRequest.class,
            OrderResponse.class,
    ...
    Flow<AnalyticsRequest, AnalyticsResponse, Void> generateAnalytics =
        genkit.defineFlow(
            "generateAnalytics",
            ...
            (request) -> {
              ...
              AnalyticsResponse.ChangeIndicator revenueChange =
                  new AnalyticsResponse.ChangeIndicator();
              ...
              AnalyticsResponse.TrendIndicator revenueTrend =
                  new AnalyticsResponse.TrendIndicator();
              ...
              AnalyticsResponse.VisualizationData vizData =
                  new AnalyticsResponse.VisualizationData();
              ...
              AnalyticsResponse.VisualizationConfig vizConfig =
                  new AnalyticsResponse.VisualizationConfig();
              ...
              // Set metadata
              AnalyticsResponse.ResponseMetadata metadata =
                  new AnalyticsResponse.ResponseMetadata();
    ...
    Flow<List<String>, Map<String, Object>, Void> processBatch =
        genkit.defineFlow(
            "processBatch",
    ...
    Flow<OrderRequest, Map<String, Object>, Void> simplifyOrder =
        genkit.defineFlow(
            "simplifyOrder",
            OrderRequest.class,
            (Class<Map<String, Object>>) (Class<?>) Map.class,
    ...
    Flow<OrderRequest, ValidationResult, Void> validateOrder =
        genkit.defineFlow(
            "validateOrder",
            OrderRequest.class,
              ...
              if (order.getItems() == null || order.getItems().isEmpty()) {
                ...
                for (int i = 0; i < order.getItems().size(); i++) {
                  ...
                  if (item.getQuantity() != null && item.getQuantity() > 100) {
                    ValidationResult.ValidationWarning warning =
