 ...
 *
 * <p>This sample demonstrates the multi-agent pattern where:
 *
 * <ul>
 *   <li>A triage agent routes requests to specialized agents
 *   <li>Specialized agents handle specific domains (reservations, menu, etc.)
 *   <li>Agents can be used as tools for delegation
 * </ul>
 *
 * <p>To run:
 *
 ...
 *   <li>Run: mvn exec:java -pl samples/multi-agent
 * </ol>
 */
public class MultiAgentApp {
  ...
  public static class CustomerState {
    ...
    public String toString() {
      return String.format(
          "Customer: %s, Agent: %s, Reservations: %d, Orders: %d",
          customerId, currentAgent, reservations.size(), orders.size());
    }
  }
  ...
  public MultiAgentApp() {
    ...
    this.genkit =
        Genkit.builder()
            .options(GenkitOptions.builder().devMode(true).reflectionPort(3101).build())
  ...
  private void initializeTools() {
    ...
    makeReservationTool =
        genkit.defineTool(
            "makeReservation",
            "Makes a restaurant reservation for the customer",
            Map.of(
                "type",
                "object",
                "properties",
                Map.of(
                    ...
                    "time",
                    Map.of("type", "string", "description", "Time in HH:MM format"),
                    "partySize",
                    Map.of("type", "integer", "description", "Number of guests")),
                "required",
                new String[] {"date", "time", "partySize"}),
            ...
            (ctx, input) -> {
              ...
              result.put(
                  "message",
                  String.format(
                      "Reservation confirmed for %d guests on %s at %s. Confirmation: %s",
    ...
    getMenuTool =
        genkit.defineTool(
            "getMenu",
            "Gets the current restaurant menu",
            Map.of(
                "type",
                "object",
                "properties",
                Map.of(
                    ...
                    Map.of(
                        ...
                        "string",
                        "description",
                        "Menu category: appetizers, mains, desserts, drinks, or all",
                        "enum",
                        new String[] {"appetizers", "mains", "desserts", "drinks", "all"}))),
            (Class<Map<String, Object>>) (Class<?>) Map.class,
            (ctx, input) -> {
              String category =
                  input.get("category") != null ? (String) input.get("category") : "all";
              ...
              if (category.equals("all") || category.equals("drinks")) {
                menu.put(
                    "drinks",
                    List.of(
                        Map.of("name", "House Wine", "price", 8.99, "description", "Red or white"),
                        Map.of(
                            "name",
                            "Craft Beer",
                            "price",
    ...
    placeOrderTool =
        genkit.defineTool(
            "placeOrder",
            "Places a food order for pickup or delivery",
            Map.of(
                "type",
                "object",
                "properties",
            ...
            (ctx, input) -> {
              ...
              result.put(
                  "message",
                  String.format(
                      "Order %s placed for %s. Items: %s. Ready in %s.",
                      orderId,
                      orderType,
                      String.join(", ", items),
    ...
    reservationAgent =
        genkit.defineAgent(
            AgentConfig.builder()
                ...
                .description(
                    "Handles restaurant reservations. Transfer to this agent when the customer "
                        + "wants to make, modify, or cancel a reservation.")
                .system(
                    "You are a reservation specialist for an upscale restaurant. "
    ...
    menuAgent =
        genkit.defineAgent(
            AgentConfig.builder()
                .name("menuAgent")
                .description(
                    "Provides menu information. Transfer to this agent when the customer "
                        + "wants to know about menu items, prices, or recommendations.")
                .system(
                    "You are a menu expert at an upscale restaurant. "
                ...
                .model("openai/gpt-4o-mini")
                .tools(List.of(getMenuTool))
                .config(GenerationConfig.builder().temperature(0.5).build())
                .build());
    ...
    orderAgent =
        genkit.defineAgent(
            AgentConfig.builder()
                .name("orderAgent")
                .description(
                    "Handles food orders for pickup or delivery. Transfer to this agent when "
                ...
                .system(
                    "You are an order specialist for a restaurant. "
                        ...
                        + "Confirm all items before placing the order. "
                        + "Provide accurate time estimates.")
                .model("openai/gpt-4o-mini")
                .tools(List.of(placeOrderTool, getMenuTool))
                .config(GenerationConfig.builder().temperature(0.3).build())
                .build());
    ...
    triageAgent =
        genkit.defineAgent(
            AgentConfig.builder()
                ...
                .system(
                    "You are the main customer service agent for The Golden Fork restaurant. "
  ...
  public void runInteractive() {
    ...
    while (true) {
      ...
      if (input.equals("/status")) {
        ...
        System.out.println(
            "Current Agent: " + (currentAgent != null ? currentAgent : "triage (default)") + "\n");
        continue;
      }
  ...
  public void runDemo() {
    ...
    // Demo conversation
    String[] messages = {
      "Hi, I'd like to make a reservation for this weekend",
      "Saturday at 7pm for 4 people",
