...
public class RagSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    logger.info("   curl -X POST http://localhost:8080/api/flows/indexWorldCapitals");
    logger.info("   curl -X POST http://localhost:8080/api/flows/indexDogBreeds");
    logger.info("   curl -X POST http://localhost:8080/api/flows/indexCoffeeFacts");
    logger.info("");
    logger.info("2. Then query:");
    logger.info("   curl -X POST http://localhost:8080/api/flows/askAboutCapitals \\");
    logger.info("     -H 'Content-Type: application/json' \\");
    logger.info("     -d '\"What is the capital of France?\"'");
    logger.info("");
    logger.info("   curl -X POST http://localhost:8080/api/flows/askAboutDogs \\");
    logger.info("     -H 'Content-Type: application/json' \\");
    logger.info("     -d '\"What are good family dogs?\"'");
    logger.info("");
    logger.info("   curl -X POST http://localhost:8080/api/flows/askAboutCoffee \\");
    logger.info("     -H 'Content-Type: application/json' \\");
    logger.info("     -d '\"How is espresso made?\"'");
    logger.info("");
    logger.info("3. Retrieve without generation:");
    logger.info("   curl -X POST http://localhost:8080/api/flows/retrieveDocuments \\");
    logger.info("     -H 'Content-Type: application/json' \\");
