 ...
 *
 * <ul>
 *   <li>Configure the MCP plugin with different server types
 *   <li>Connect to MCP servers via STDIO (local processes) and HTTP
 *   <li>Use MCP tools in Genkit flows
 *   <li>Access MCP resources
 *   <li>Combine MCP tools with AI models for powerful workflows
 * </ul>
 *
 * <p>Prerequisites:
 *
 * <ul>
 *   <li>Node.js and npm installed (for MCP server packages)
 *   <li>OPENAI_API_KEY environment variable set
 * </ul>
 *
 * <p>To run:
 *
 ...
 * </ol>
 *
 * <p>Available MCP servers in this sample:
 *
 * <ul>
 *   <li>filesystem: Access files using @modelcontextprotocol/server-filesystem
 *   <li>everything: Demo server with various tool types
 * </ul>
 */
  ...
  public static void main(String[] args) throws Exception {
    ...
    MCPPluginOptions mcpOptions =
        MCPPluginOptions.builder()
            ...
            .addServer(
                "everything",
                MCPServerConfig.stdio("npx", "-y", "@modelcontextprotocol/server-everything"))
            .build();
    ...
    Flow<Void, String, Void> listToolsFlow =
        genkit.defineFlow(
            "listMcpTools",
            Void.class,
            String.class,
    ...
    Flow<String, String, Void> fileAssistantFlow =
        genkit.defineFlow(
            "fileAssistant",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system(
                              "You are a helpful file assistant. You can read, write, and list files "
    ...
    Flow<String, String, Void> readFileFlow =
        genkit.defineFlow(
            "readFile",
            String.class,
            String.class,
            (ctx, filePath) -> {
              ...
              try {
                Object result =
                    mcpPlugin.callTool("filesystem", "read_file", Map.of("path", filePath));
    ...
    Flow<String, String, Void> listResourcesFlow =
        genkit.defineFlow(
            "listResources",
            String.class,
            String.class,
    ...
    Flow<String, String, Void> toolExplorerFlow =
        genkit.defineFlow(
            "toolExplorer",
            String.class,
            String.class,
    ...
    Flow<Void, String, Void> serverStatusFlow =
        genkit.defineFlow(
            "mcpStatus",
            Void.class,
            String.class,
    ...
    Flow<String, String, Void> writeReadDemoFlow =
        genkit.defineFlow(
            "writeReadDemo",
            String.class,
            String.class,
            (ctx, content) -> {
              ...
              try {
                ...
                mcpPlugin.callTool(
                    "filesystem", "write_file", Map.of("path", testFile, "content", content));
                sb.append("Write successful!\n\n");

                // Read it back
                sb.append("Reading file back:\n");
                Object readResult =
                    mcpPlugin.callTool("filesystem", "read_file", Map.of("path", testFile));
