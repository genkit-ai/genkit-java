 ...
 *
 * <p>This example shows how to: - Configure Genkit with the Mistral plugin - Use Mistral Large for
 * complex tasks - Use smaller models for efficient processing - Use specialized models (Codestral
 * for code, Pixtral for vision) - Define flows with tool usage - Generate and stream responses
 *
 * <p>To run: 1. Set the MISTRAL_API_KEY environment variable 2. Run: mvn exec:java
 */
public class MistralSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Flow<String, String, Void> greetingFlow =
        genkit.defineFlow(
            "greeting", String.class, String.class, (name) -> "Hello from Mistral, " + name + "!");
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system("You are a helpful AI assistant powered by Mistral AI.")
                          .prompt(userMessage)
                          .build());
    ...
    Tool<Map<String, Object>, Map<String, Object>> translateTool =
        genkit.defineTool(
            "translate",
    ...
    Flow<String, String, Void> translationAssistantFlow =
        genkit.defineFlow(
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system(
                              "You are a translation assistant. Use the translate tool when needed to translate text.")
                          .prompt(userMessage)
    ...
    Flow<String, String, Void> codeGenFlow =
        genkit.defineFlow(
            "generateCode",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system(
                              "You are Codestral, an expert programming assistant. Write clean, efficient, well-documented code.")
                          .prompt(prompt)
                          .config(
    ...
    Flow<String, String, Void> quickQAFlow =
        genkit.defineFlow(
            "quickQA",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system("You are a helpful assistant. Provide quick, accurate answers.")
                          .prompt(question)
                          .config(
                              GenerationConfig.builder()
                                  .maxOutputTokens(500)
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          ...
                          .system(
                              "You are a balanced assistant. Provide helpful responses efficiently.")
                          .prompt(userMessage)
                          .config(
                              GenerationConfig.builder()
                                  .maxOutputTokens(800)
              ...
              ModelResponse response =
                  genkit.generateStream(
                      GenerateOptions.builder()
                          .model("mistral/mistral-large-2512")
                          .system(
                              "You are a creative writer. Write engaging, imaginative content with vivid descriptions.")
                          .prompt(prompt)
                          .config(
                              GenerationConfig.builder()
    ...
    System.out.println(
        "  POST http://localhost:8080/api/flows/streamingChat (mistral-small with streaming)");
