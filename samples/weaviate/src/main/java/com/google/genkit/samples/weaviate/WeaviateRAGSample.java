 ...
 *
 * <ul>
 *   <li>Configure Weaviate plugin with collection settings
 ...
 *   <li>Running Weaviate instance (local or cloud)
 *   <li>Optional: WEAVIATE_HOST, WEAVIATE_PORT, WEAVIATE_API_KEY
 * </ul>
 */
public class WeaviateRAGSample {
  ...
  public static void main(String[] args) {
    ...
    if (weaviateApiKey != null && !weaviateApiKey.isBlank()) {
      ...
      // Local configuration
      weaviateBuilder =
          WeaviatePlugin.local(weaviateHost).port(weaviatePort).grpcPort(weaviateGrpcPort);
    }
