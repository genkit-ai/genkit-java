 ...
 *
 * <p>This example shows how to: - Configure Genkit with the Ollama plugin - Define flows using
 * local Ollama models - Generate text with various open-source models - Use streaming for real-time
 * responses - Expose flows via HTTP endpoints
 *
 * <p>Prerequisites: 1. Install Ollama from https://ollama.ai 2. Pull a model: ollama pull llama3.2
 * 3. Ensure Ollama is running (it starts automatically after installation)
 *
 * <p>To run: mvn exec:java
 */
public class OllamaSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    OllamaPlugin ollama =
        new OllamaPlugin(OllamaPluginOptions.builder().models("gemma3n:e4b").build());
    ...
    Flow<String, String, Void> quickAnswerFlow =
        genkit.defineFlow(
            "quickAnswer",
            String.class,
            String.class,
            (ctx, question) -> {
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          .model("ollama/gemma3n:e4b")
                          .system("You are a helpful assistant. Give brief, direct answers.")
                          .prompt(question)
                          .config(
                              GenerationConfig.builder()
                                  .maxOutputTokens(200)
              ...
              ModelResponse response =
                  genkit.generateStream(
                      GenerateOptions.builder()
                          .model("ollama/gemma3n:e4b")
                          .system(
                              "You are a creative writer. Write engaging, imaginative stories "
    ...
    Flow<String, String, Void> translateFlow =
        genkit.defineFlow(
            "translate",
            String.class,
            String.class,
              ...
              ModelResponse response =
                  genkit.generate(
                      GenerateOptions.builder()
                          .model("ollama/gemma3n:e4b")
                          .system(
                              "You are a translator. Translate the given text to Spanish. "
